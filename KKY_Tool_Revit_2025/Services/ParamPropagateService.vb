...
#End If
            ...
            Dim okNow As Boolean =
                (corrected IsNot Nothing AndAlso corrected.IsShared AndAlso BuiltInParameterGroupCompat.IsInGroup(corrected.Definition, groupPG))
...
#End If
            ...
            corrected =
                ...
                FirstOrDefault(Function(x) x.Definition IsNot Nothing AndAlso
                                           x.IsShared AndAlso
                                           String.Equals(x.Definition.Name, extDef.Name, StringComparison.OrdinalIgnoreCase))
            result.FinalOk = (corrected IsNot Nothing AndAlso BuiltInParameterGroupCompat.IsInGroup(corrected.Definition, groupPG))
            Return result
        End Function
